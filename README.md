[![Build (Windows)](https://github.com/SAM-BIM/SAM_SQLite/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/SAM-BIM/SAM_SQLite/actions/workflows/build.yml)
...
**SAM_SQLite** is part of the **SAM (Sustainable Analytical Model) Toolkit** —  
...
This repository provides **SQLite-based persistence and data-exchange utilities**
